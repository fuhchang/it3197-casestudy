...
public class UpdateEventStep2ValidationController implements Settings{
	...
	public UpdateEventStep2ValidationController(UpdateEventStep2Activity activity, EventLocationDetail eventLocationDetails, String posterFileName){
	...
	public void validateForm(Intent intent, Calendar calendarFrom, Calendar calendarTo, Event event, String occurence, boolean requestHelp){
		...
		if((calendarFrom.after(calendarTo))){
			...
			if(!Session.getActiveSession().isClosed()){
				...
				UpdateEvent updateEvent = new UpdateEvent(activity,event,eventLocationDetails,dialog,requestHelp);
				updateEvent.execute();
			}
		}
	}
	            ...
	            public void onCompleted(Response response) {
	                try {
	                	if(response != null){
			                ...
			                System.out.println("FB: " + response.toString());
